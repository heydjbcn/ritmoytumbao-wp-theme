...
<section class="bg-ink-dark text-white relative overflow-hidden">
    ...
    <div class="relative z-10 max-w-[1220px] mx-auto px-6 py-[100px] text-center">
        <?php ryt_eyebrow('', 'Estamos aquí para ti'); ?>
        <h1 class="text-white" style="font-size: 58px; line-height: 1.05;">
            Hablemos de
            <span class="italic font-display text-ryt-mint">baile</span>
        </h1>
        <p class="text-[17px] text-[#E6E1DB] leading-[1.7] mt-6 max-w-[640px] mx-auto">
            Resolvemos tus dudas en menos de 24h. Por WhatsApp, por email o pasándote por la escuela.
        </p>
    </div>
</section>
...
<section class="bg-paper py-[100px] px-6">
    <div class="max-w-[1180px] mx-auto grid gap-[48px] lg:grid-cols-[1fr_1.1fr]">
        ...
        <div class="bg-white rounded-[22px] border border-[#EFEBE6] p-[34px] shadow-[0_10px_30px_rgba(38,37,36,0.05)]">
            <?php ryt_eyebrow('01', 'Escuela Ritmo y Tumbao'); ?>
            <h2 class="text-ink-heading mb-[28px]" style="font-size: 32px; line-height: 1.14;">
                Tu escuela de baile<br>en Mataró
            </h2>
            ...
            <div class="flex flex-col gap-[22px]">
                ...
                <a href="<?php echo esc_url(RYT_ADDRESS_MAPS); ?>" target="_blank" rel="noopener" class="flex gap-3 group">
                    ...
                    <div>
                        <p class="text-[11px] font-bold uppercase tracking-[0.12em] text-ryt-mint mb-0.5">Dirección</p>
                ...
                <div class="flex gap-3">
                    ...
                    <div>
                        <p class="text-[11px] font-bold uppercase tracking-[0.12em] text-ryt-mint mb-0.5">Teléfono</p>
                ...
                <div class="flex gap-3">
                    ...
                    <div>
                        <p class="text-[11px] font-bold uppercase tracking-[0.12em] text-ryt-mint mb-0.5">Email</p>
                ...
                <div class="flex gap-3">
                    ...
                    <div>
                        <p class="text-[11px] font-bold uppercase tracking-[0.12em] text-ryt-mint mb-0.5">Horario oficina</p>
                ...
                <div class="pt-3 mt-1 border-t border-[#EFEBE6]">
                    <p class="text-[11px] font-bold uppercase tracking-[0.12em] text-ink-soft mb-3">Síguenos</p>
        ...
        <div>
            ...
            <form action="<?php echo esc_url(admin_url('admin-post.php')); ?>" method="post" class="space-y-3">
                ...
                <label class="block">
                    ...
                    <textarea name="mensaje" rows="5" required class="mt-1 w-full rounded-2xl border border-[#EFEBE6] bg-white px-4 py-3 text-sm focus:outline-none focus:border-ryt-mint" placeholder="¿En qué te ayudamos?"></textarea>
                </label>
...
<section class="bg-white">
    <div class="max-w-[1320px] mx-auto px-6 py-[80px]">
        <div class="grid grid-cols-1 lg:grid-cols-[1.3fr_1fr] gap-[48px] items-end mb-[32px]">
            <div>
                <?php ryt_eyebrow('03', 'Cómo llegar'); ?>
                <h2 class="text-ink-heading" style="font-size: 38px; line-height: 1.1;">
                    Estamos a 5 min<br>del centro de Mataró
                </h2>
            </div>
            <div>
                <p class="text-[16px] leading-[1.7] text-ink-soft">
                    <?php echo esc_html(RYT_ADDRESS); ?>. Aparcamiento sencillo en la zona y a pocos pasos del transporte público.
                </p>
            </div>
        </div>
